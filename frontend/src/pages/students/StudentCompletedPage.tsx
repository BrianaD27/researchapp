...
import AppliedCompletedStudentsInfoCard from "../../components/cards/AppliedCompletedStudentsIntoCard";

const StudentCompletedPage = () => {
      ...
      <div className="pt-5 flex-1 flex items-start justify-evenly">
        ...
        <div className="flex flex-col align-items-center justify-start">
          ...
          <div className="flex mt-5 flex-row justify-between items-center">
            <p className="text-white pt-2 text-lg">Saved Opportunities</p>
        ...
        {/* Student Info Box */}
        <div>
          <AppliedCompletedStudentsInfoCard process="Completed" />
        </div>
      </div>
    </div>
  );
...
export default StudentCompletedPage;
