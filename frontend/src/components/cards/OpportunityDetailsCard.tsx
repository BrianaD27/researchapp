  ...
  return (
    <div className="hidden md:flex md:flex-col h-173 xl:w-130 lg:w-100 md:w-80 w-30 bg-white scroll-auto rounded-lg shadow-lg items-center p-4 gap-1">
      ...
      <div className="flex flex-row gap-4 mt-2">
        <button className="text-white font-semibold text-xl hover:cursor-pointer bg-green-500 border rounded-3xl py-2 px-6">
          Apply
        </button>
        <button className="text-white font-semibold text-xl hover:cursor-pointer bg-orange-500 border rounded-3xl py-2 px-6">
          {savedBtn}
        </button>
        <button className="text-white font-semibold text-xl hover:cursor-pointer bg-blue-500 border rounded-3xl py-2 px-6">
          Email
        </button>
      </div>
    </div>
